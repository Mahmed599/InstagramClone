...
const SuggestedUsers = () => {
  return (
    <VStack py={8} px={6} gap={4}>
      ...
      <SuggestedUser name='Ryan Florence' followers={597} avatar='https://bit.ly/ryan-florence'/>
      <SuggestedUser name='Christian Nwamba' followers={759} avatar='https://bit.ly/code-beast'/>

      <Box fontSize={12} color={"gray.500"} mt={5} alignSelf={"start"}>
      © 2024 Built By{" "}
	  <Link href='https://github.com/Mahmed599' target='_blank' color='blue.500' fontSize={14}>
		Mohamed Ahmed
	  </Link>
      </Box>
